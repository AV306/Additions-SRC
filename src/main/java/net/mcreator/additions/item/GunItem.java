...
import net.mcreator.additions.procedures.GunBulletHitsLivingEntityProcedure;
...
public class GunItem extends AdditionsModElements.ModElement {
	@ObjectHolder("additions:gun")
	public static final Item block = null;
	@ObjectHolder("additions:entitybulletgun")
	public static final EntityType arrow = null;
	public GunItem(AdditionsModElements instance) {
		super(instance, 23);
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(AdditionsItemGroup.tab).maxStackSize(1));
			setRegistryName("gun");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Ah well."));
		}
