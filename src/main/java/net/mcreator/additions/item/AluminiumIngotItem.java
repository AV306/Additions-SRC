...
public class AluminiumIngotItem extends AdditionsModElements.ModElement {
	@ObjectHolder("additions:aluminium_ingot")
	public static final Item block = null;
	public AluminiumIngotItem(AdditionsModElements instance) {
		super(instance, 33);
	}
