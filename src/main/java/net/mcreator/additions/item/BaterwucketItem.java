...
public class BaterwucketItem extends AdditionsModElements.ModElement {
	@ObjectHolder("additions:baterwucket")
	public static final Item block = null;
	public BaterwucketItem(AdditionsModElements instance) {
		super(instance, 17);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("(c) Phoenix SC"));
		}
	}
}
