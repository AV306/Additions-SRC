...
public class GrannyEssenceBlock extends AdditionsModElements.ModElement {
	@ObjectHolder("additions:granny_essence")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("additions:granny_essence_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public GrannyEssenceBlock(AdditionsModElements instance) {
		super(instance, 5);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("additions:blocks/granny"), new ResourceLocation("additions:blocks/granny"))
						.luminosity(0).density(-1000).viscosity(1000).gaseous()).bucket(() -> bucket).block(() -> block);
		still = (FlowingFluid) new ForgeFlowingFluid.Source(fluidproperties).setRegistryName("granny_essence");
		flowing = (FlowingFluid) new ForgeFlowingFluid.Flowing(fluidproperties).setRegistryName("granny_essence_flowing");
		elements.blocks.add(() -> new FlowingFluidBlock(still, Block.Properties.create(Material.LAVA)) {
		}.setRegistryName("granny_essence"));
		elements.items
				.add(() -> new BucketItem(still, new Item.Properties().containerItem(Items.BUCKET).maxStackSize(1).group(AdditionsItemGroup.tab))
						.setRegistryName("granny_essence_bucket"));
	}
