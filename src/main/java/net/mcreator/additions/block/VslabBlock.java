...
public class VslabBlock extends AdditionsModElements.ModElement {
	@ObjectHolder("additions:universalslab")
	public static final Block block = null;
	public VslabBlock(AdditionsModElements instance) {
		super(instance, 14);
	}
