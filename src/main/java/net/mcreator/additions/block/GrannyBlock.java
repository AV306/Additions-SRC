...
public class GrannyBlock extends AdditionsModElements.ModElement {
	@ObjectHolder("additions:granny")
	public static final Block block = null;
	@ObjectHolder("additions:granny")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public GrannyBlock(AdditionsModElements instance) {
		super(instance, 4);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("granny"));
	}
	public static class CustomBlock extends Block {
		public static final DirectionProperty FACING = HorizontalBlock.HORIZONTAL_FACING;
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.ANVIL).hardnessAndResistance(255f, 255f).lightValue(0));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH));
			setRegistryName("granny");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("I AM GRANNY"));
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("granny");
		}
