...
public class AluminiumBlockBlock extends AdditionsModElements.ModElement {
	@ObjectHolder("additions:aluminium_block")
	public static final Block block = null;
	public AluminiumBlockBlock(AdditionsModElements instance) {
		super(instance, 35);
	}
