...
public class OilBlock extends AdditionsModElements.ModElement {
	@ObjectHolder("additions:oil")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("additions:oil_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public OilBlock(AdditionsModElements instance) {
		super(instance, 25);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("additions:blocks/bevel"), new ResourceLocation("additions:blocks/bevel")).luminosity(0)
						.density(1000).viscosity(2100)).bucket(() -> bucket).block(() -> block);
